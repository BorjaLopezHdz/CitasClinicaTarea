...
public class MainApp {
	...
	public static void main(String[] args) throws OperationNotSupportedException{
		System.out.println("Bienvenid@ al programa para gestionar las citas de la Clínica.");
	...
	private static void insertarCita() throws OperationNotSupportedException {
		try {
			...
			System.out.println("");
			System.out.println("¡La cita ha sido asignada correctamente!");
			System.out.println("");
			Consola.mostrarMenu();
			ejecutarOpcion(Consola.elegirOpcion());
	...
	private static void mostrarCitasDia() throws OperationNotSupportedException {
		...
		System.out.println("");
		System.out.println("Lista de citas para la fecha: " + fecha.format(formato));
		System.out.println("");
