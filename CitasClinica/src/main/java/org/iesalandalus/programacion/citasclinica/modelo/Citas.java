...
public class Citas {
	...
	public Citas(int capacidadColeccion) {
		if (capacidadColeccion <= 0) {
			throw new IllegalArgumentException("ERROR: La capacidad debe ser superior a cero.");
		}
	...
	public void insertar(Cita cita) throws OperationNotSupportedException {
		...
		if (capacidadSuperada(indice)) {
			throw new OperationNotSupportedException("ERROR: No se pueden aceptar más citas.");
		}
